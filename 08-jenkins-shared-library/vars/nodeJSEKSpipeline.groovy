    ...
    pipeline {
        ...
        stages {
            ...
            stage('Deploy') {
                ...
                steps {
                    // build job path should be carefull. We have to modify the path accordingly.
                    // if build job path is different in jenkins, we have give it here. 
